...
<form method="POST"/>
choose the grade of Algebra and Number Theory<select name="sub1">
	<option>O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choose the grade of Computer Networks<select name="sub2">
    <option >O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choose the grade of Microprocessors and Micro Controllers<select name="sub3">
    <option >O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choose the grade of Web Technology<select name="sub4">
    <option>O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choose the grade Software Engineeering<select name="sub5">
    <option >O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choose the grade of Open Elective<select name="sub6">
    <option >O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choosethe grade of Microproceesor and Microcontroller Laboratory<select name="lab1">
    <option >O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choose the grade of Networks Laboratory<select name="lab2">
    <option> O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
...
choose the grade of Web Technology Laboratory<select name="lab3">
    <option >O</option>
	<option>A+</option>
        <option>A</option>
        <option>B+</option>
